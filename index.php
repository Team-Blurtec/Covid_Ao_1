...
<div>
    <div class="header-dark"
         style="background-image: url(&quot;assets/img/download.png?h=c3d0f8c013a249f0ca03f1b6ed591c4f&quot;);padding: 3px;">
        <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
            <div class="container">
                <h4 class="heading"><a title="COVID-19 TRACKER BY BLURTEC" href="#"><span class="background"
                                                                                          style="background-color: rgb(199,12,0);">ANGOLA&nbsp;</span><span
                                class="border"
                                style="background-color: rgb(255,207,35);color: rgb(0,0,0);">COVID-19</span></a></h4>
            </div>
        </nav>
    </div>
    <div></div>
    ...
    <div class="container" style="background-color: #000000;">
        ...
        <div class="row features">
            <div class="col-sm-6 col-lg-4 item">
                ...
                <p class="description">O portal Covid-19.AO monitora registo da Covid-19 no nosso país. Destacando 4
                    pontos importantes, os quais:</p>
                ...
                <p class="description"> Assim, levando em consideração informações da propagação e medidas de prevenção
                    da Covid-19 no país.</p>
            </div>
            <div class="col-sm-6 col-lg-4 item">
                ...
                <p class="description">Este portal funciona de modo a manter informado a população
                    Angolana no âmbito da pandemia que se propagou pelo mundo.
                    Levando informações em dados da Covid-19 pelas 18 Províncias, Deste Casos Confirmados, Activos,
                    Recuperados e Óbitos.</p>
            </div>
            <div class="col-sm-6 col-lg-4 item">
                <h3 class="name" style="color:  #eead2d;">De onde vem os nossos dados</h3>
                <p class="description">Os Dados do Portal Covid-19.AO,
                    Provêm de Actualizaçōes Feitas Diariamente Pelo Sector do Ministério da Saúde de Angola 🇦🇴 .
                    O portal Comporta um Banco de Dados Estruturado e Normalizado que alberga Os Registos da Pandemia
                    nos País.</p>
            </div>
        </div>
        <div class="row">
            <div class="container">
                ...
                <div class="card-header" style="background-color:#1b1e21 ;color:  #eead2d;">
                    ...
                    while ($dados = mysqli_fetch_array($buscar)) {
                        ...
                        ?>
                        <h4 class="heading"
                            style="background-color: rgba(0,0,0,0);color:  #eead2d; animation: ease-in-out">
                            <span class="border"
                                  style="background-color:black;color:red;">CONFIRMADOS-<?php echo $c_confirm ?></span>
                            -
                            <span class="border"
                                  style="background-color:red;color: rgb(0,0,0);">ACTIVOS-<?php echo $c_activos ?></span>
                            -
                            <span class="border"
                                  style="background-color:green;color: rgb(0,0,0);">RECUPERADOS-<?php echo $c_recuperados ?></span>
                            -
                            <span class="border"
                                  style="background-color:gray;color: rgb(0,0,0);">OBITOS-<?php echo $c_mortes ?></span>
                            - TOTAL NO PAIS
                        </h4>
            ...
            <div class="col">
                <div class="card-header" style="background-color:#1b1e21 ;color:  #eead2d;">
                    <h4 class="card-title" style="text-align: center"
                        style="background-color: rgba(0,0,0,0);color:  #eead2d;">Angola</h4>
        ...
        <div class="row">
            <div class="col">
                <div>
                    <div class="card ">
                        <div class="card-header " style="background-color:#1b1e21 ;color:  #eead2d;">
                            <h4 class="card-title" style="text-decoration-color: yellow">Progressão Covid-19 Angola</h4>
