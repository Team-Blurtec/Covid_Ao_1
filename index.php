        ...
        <div class="container" style="background-color: #ffffff;background-image: url(&quot;assets/img/7ccb010d8fddc4bcd84587ef3c34d100.jpg?h=bf48bdc5edd7f51c23b94bc585baa661&quot;);">
            ...
            <div class="row features">
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <p class="text-left description" style="color: #000000;font-size: 20px;">&nbsp; &nbsp;O portal Covid-19.AO monitora registros da Covid-19 no nosso país. Destacando 4 pontos importantes, os quais:<br>&nbsp; &nbsp;1)Casos Confirmados,<br>&nbsp; &nbsp;2)Activos, <br>&nbsp; &nbsp;3)Recuperados,<br>&nbsp; &nbsp;4)Óbitos.<br>Assim,
                        levando as informações da propagação e medidas de prevenção da Covid-19 no país.</p>
                </div>
                <div class="col-sm-6 col-lg-4 item">
                    <h3 class="name" style="color: #ffa900;">Como Funciona o nosso portal ?</h3>
                    <p class="text-left description" style="color: rgb(0,0,0);font-size: 20px;">&nbsp; &nbsp;Este portal funciona de modo a manter informado a população Angolana no âmbito da pandemia que propagou-se pelo mundo. Levando informações em dados da Covid-19 pelas 18 províncias, deste casos confirmados, activos, recuperados
                        e óbitos.</p>
                </div>
                <div class="col-sm-6 col-lg-4 item">
                    <h3 class="name" style="color: #ffa900;">De onde vem os nossos dados ?</h3>
                    <p class="description" style="color: rgb(0,0,0);font-size: 20px;">&nbsp; &nbsp;Os dados do portal Covid-19.AO, provêem de actualizaçōes feitas diariamente pelo sector do Ministério da Saúde de Angola 🇦🇴 . O portal comporta um banco de dados estruturado e normalizado que alberga os registros da
                        pandemia no país.<br></p>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-6">
                                            ...
                                            <div class="small-box" style="background-color: rgba(139,139,139,0.18);">
                                                ...
                                                <h5 href="#" class="small-box-footer" style="color: black">Óbitos</h5>
                                            </div>
                                        </div>
                                        <!-- ./col -->
                                    </div>
                                    <div class="container">
                                        <p class="text-center mt-5"  style="color: rgb(0,0,0);">Ultima Actulização&nbsp;<?php echo $c_data?></p>
