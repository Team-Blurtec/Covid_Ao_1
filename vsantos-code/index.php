...
<head>
    ...
    <link rel="stylesheet" href="assets/css/Panel-Glass-1.css">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="glass-panel dark">
                    <div class="panel-glass-reflexion"></div>
                    <div class="panel-glass-content">
                        <div class="card my-4" style="background-color: #1b1e21">
                            <div class="card-body" style="background-color: #1b1e21">
                                <div class="table-responsive" id="registros" style="width: max-content;height: max-content">
            ...
            <div class="col-md-7">
                <div class="glass-panel dark">
                    <div class="panel-glass-reflexion"></div>
                    <div class="panel-glass-content">
                        <div class="card my-4" style="background-color: #d8c400">
                            <div class="card-body" style="background-color: #000001">
                                <h2 >COVID INFO</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed justo odio,
                                    lobortis eu rutrum commodo, elementum non tortor. Sed ac suscipit urna, quis aliquam ante. Maecenas at lacinia dui. </p>
                                <h2 >COVID INFO</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed justo odio,
                                    lobortis eu rutrum commodo, elementum non tortor. Sed ac suscipit urna, quis aliquam ante. Maecenas at lacinia dui. </p>
                                <h2 >COVID INFO</h2>
        ...
        <div class="col-md-12" style="text-align: center;align-content: center">
            ...
            <div class="card-header"STYLE="background-color: whitesmoke">
                <h4 class="card-title" style="text-align: center">Angola</h4>
        ...
        <div class="fa-search-plus"> <div class="card-body "> </div> </div>
