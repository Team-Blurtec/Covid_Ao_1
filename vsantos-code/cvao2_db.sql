...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2020 at 05:23 PM
...
--
ALTER TABLE `admin`
    ADD CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`id`) REFERENCES `casos` (`idAdmin`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `datas`
--
ALTER TABLE `datas`
    ADD CONSTRAINT `datas_ibfk_1` FOREIGN KEY (`id`) REFERENCES `casos` (`idData`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
