...
function () {
  function TooltipUI($node, options) {
    ...
    this.$node = $node;
    this.options = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.index2.extend({}, {
      title: '',
...
var editor = renderer["index2.php" /* default */].create('<div class="note-editor note-frame"/>');
var toolbar = renderer["index2.php" /* default */].create('<div class="note-toolbar" role="toolbar"/>');
...
var editable = renderer["index2.php" /* default */].create('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>');
var statusbar = renderer["index2.php" /* default */].create(['<output class="note-status-output" role="status" aria-live="polite"/>', '<div class="note-statusbar" role="status">', '<div class="note-resizebar" aria-label="resize">', '<div class="note-icon-bar"/>', '<div class="note-icon-bar"/>', '<div class="note-icon-bar"/>', '</div>', '</div>'].join(''));
...
var buttonGroup = renderer["index2.php" /* default */].create('<div class="note-btn-group">');
var ui_button = renderer["index2.php" /* default */].create('<button type="button" class="note-btn" tabindex="-1">', function ($node, options) {
  // set button type
...
var dropdown = renderer["index2.php" /* default */].create('<div class="note-dropdown-menu" role="list">', function ($node, options) {
...
var dropdownCheck = renderer["index2.php" /* default */].create('<div class="note-dropdown-menu note-check" role="list">', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
...
var palette = renderer["index2.php" /* default */].create('<div class="note-color-palette"/>', function ($node, options) {
  var contents = [];
...
var dialog = renderer["index2.php" /* default */].create('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  if (options.fade) {
    $node.addClass('fade');
  }
...
var popover = renderer["index2.php" /* default */].create(['<div class="note-popover bottom">', '<div class="note-popover-arrow"/>', '<div class="popover-content note-children-container"/>', '</div>'].join(''), function ($node, options) {
...
var ui_checkbox = renderer["index2.php" /* default */].create('<div class="checkbox"></div>', function ($node, options) {
