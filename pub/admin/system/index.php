...
mysql_connect("sql307.epizy.com", "epiz_25864677", "ks9A3RXZV0sqt") or die(mysql_error());
mysql_select_db("epiz_25864677_cvao_db") or die(mysql_error());
//Retrieves the current count
$count = mysql_fetch_row(mysql_query("SELECT hits FROM visitas"));
echo "<p> <font color=blue size='4pt'> Visitas :</font> <font color=red size='4pt'>$count[0]</font></p>";
?>
<?php
// Connects to your Database
mysql_connect("sql307.epizy.com", "epiz_25864677", "ks9A3RXZV0sqt") or die(mysql_error());
mysql_select_db("epiz_25864677_cvao2_db") or die(mysql_error());
//Retrieves the current count
$coun = mysql_fetch_row(mysql_query("SELECT SUM(hits) FROM visitas"));
//echo "<p> <font color=blue size='4pt'> Visitas :</font> <font color=red size='4pt'>$coun[0]</font></p>";
?>