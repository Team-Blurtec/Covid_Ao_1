            ...
            <div class="container-fluid">
                ...
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link" href="news" style="color: #ffffff;" onmouseover="this.style.backgroundColor = 'rgb(255,214,0)'" ; onmouseout="this.style.backgroundColor = ''" ;>Notícias</a></li>
                                    ...
                                    <p class="text-center mt-5"  style="color: rgb(0,0,0);">Última Actualização:&nbsp;<?php echo $c_data?></p>
                                        ...
                                        <div class="col-xs-12">
                                            <div  class="text-center mt-5">
                                                <a class="btn btn-warning btn-lg text-center" href="news" style="color: black"  role="button">Noticias</a>
                                                <a class="btn btn-warning btn-lg text-center" data-toggle="modal" data-target="#exampleModalCenter5" style="color: black" role="button">&nbsp;&nbsp;Mapa&nbsp;&nbsp;</a>
                                            </div>
