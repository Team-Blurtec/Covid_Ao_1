...
class Auth2 extends Database
{
    ...
    public function atualizar_registo($province, $new_case, $rec_case, $dea_case, $dat_case, $u2id)
    {
        ...
        $sql_2 = "INSERT INTO provincias_filtros(nome, confirmados, activos, Recuperados, Obitos, data) VALUES (:pr,:n,:n-:r-:o,:r,:o,:datai)";
        $stmt_2 = $this->connect->prepare($sql_2);
        $query_2 = $stmt_2->execute(['n' => $new_case, 'r' => $rec_case, 'o' => $dea_case, 'pr' => $province, 'datai' => $dat_case]);

        return $query_c + $query_p + $query_2;
    }
    ...
    public function criar_registo($province, $new_case, $rec_case, $dea_case, $dat_case, $u2id)
    {
        ...
        return $query_p + $query_c + $query_2;
    }
}