...
<div class="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link" href="../sobre" style="color: #ffffff;" onmouseover="this.style.backgroundColor = 'rgb(255,214,0)'" ; onmouseout="this.style.backgroundColor = ''" ;>Sobre</a></li>
    ...
    <div class="features-clean">
        <div class="container" style="background-color: #ffffff;background-image: url(&quot;../../styles/assets_main/img/7ccb010d8fddc4bcd84587ef3c34d100.jpg?h=bf48bdc5edd7f51c23b94bc585baa661&quot;);">
                ...
                <section class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-3">
                                           <!--  <h1 class="border rounded" style="background-color: #000000;color: #ffa900;">COVID-19.AO</h1>-->
                                            <h1 class="border rounded" style="font-size: 27px;background-color: #000000;color: #ffa900;">Mapa</h1>
                                        </div>
                    ...
                    <div class="row" id="provincias">
                        <section class="col-lg-12 connectedSortable">
                            ...
                            <div class="card " id="Mapa"  style="background-color:whitesmoke ;color:  #eead2d;position: center">
                                ...
                                <div class="card-body" style="position: center">
                                    <div id="regions_div" style="position: center"></div>
                                </div>
                                <!-- /.card-body-->
