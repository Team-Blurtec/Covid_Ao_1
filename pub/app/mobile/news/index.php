...
<html xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
  <head>
      ...
      <link rel="shortcut icon" href="../../../styles/assets_news_mobile/images/bulma.png" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="../../../styles/assets_news_mobile/css/hero.css">
    <link rel="stylesheet" href="https://unpkg.com/bulma-modal-fx/dist/css/modal-fx.min.css" />
      <link rel="stylesheet" href="https://unpkg.com/bulma@0.8.2/css/bulma.min.css" />
      <script src="https://kit.fontawesome.com/7dc3015a44.js" crossorigin="anonymous"></script>
      <script src="https://cdn.jsdelivr.net/npm/vue"></script>
      <link rel="stylesheet" href="../../../styles/assets_news_mobile/css/cards.css">
  ...
  <nav class="navbar" style="background-color: black">
      <div class="container">
          <div class="navbar-brand fixed-top">
              <span class="navbar-item" href="../../../index.php"">
      ...
      <div class="columns features">
              ...
              <div class="column is-4">
                  <div class="card is-shady">
                      <div class="card-image"  data-bs-hover-animate="pulse">
                          <figure class="image">
                              <img class="card-img-top" src="../../../styles/assets_ultimas_mobile/img/1.png?h=e7103690522dc2a80ab29675d7b8545b">
                          </figure>
                      </div>
                      <div class="card-content">
                          <div class="content">
          ...
          <div class="column is-4">
              <div class="card is-shady">
                  <div class="card-image"  data-bs-hover-animate="pulse">
                      <figure class="image">
                          <img class="card-img-top" src="../../../styles/assets_ultimas_mobile/img/3.png?h=d4a192e651d1a73bda72cb14b1613187">
                      </figure>
                  </div>
                  <div class="card-content">
                      <div class="content">
          ...
          <div class="column is-4">
              <div class="card is-shady">
                  <div class="card-image"  data-bs-hover-animate="pulse">
                      <figure class="image">
                          <img class="card-img-top" src="../../../styles/assets_ultimas_mobile/img/2.png?h=a99ee867dd304fbf7c8b102cb393410a">
                      </figure>
                  </div>
                  <div class="card-content">
                      <div class="content">
  ...
  ?>
    ...
    <script src="../../../../styles/assets_news_mobile/js/wild.js"></script>
        <script>
  ...
  <script src="../../../styles/assets_news_mobile/js/cardsData.js"></script>
  ...
  <script src="../../../styles/assets_ultimas_mobile/js/jquery.min.js?h=83e266cb1712b47c265f77a8f9e18451"></script>
  <script src="../../../styles/assets_main/bootstrap/js/bootstrap.min.js?h=e46528792882c54882f660b60936a0fc"></script>
  <script src="../../../styles/assets_ultimas_mobile/js/chart.min.js?h=18313f04cea0e078412a028c5361bd4e"></script>
  <script src="../../../styles/assets_ultimas_mobile/js/script.min.js?h=53841c6e79f845ab0871ebc550cc4070"></script>
