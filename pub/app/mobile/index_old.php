...
<head>
    ...
    <link rel="shortcut icon" href="bulma.png" type="image/x-icon">
...
<script type="text/javascript">
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
            ...
            $sql="SELECT DISTINCT data,activos,recuperados FROM casos ORDER BY id DESC LIMIT 20";
            $buscar = mysqli_query($conexao,$sql);
...
<![ FIM DESENHA GRAFICO DE LINHAS ]-->
    ...
    <script type="text/javascript" src="../../styles/eff/js/popper.min.js"></script>
    <!-- Bootstrap core JavaScript -->
    <script type="text/javascript" src="../../styles/eff/js/bootstrap.min.js"></script>
    <!-- MDB core JavaScript -->
    <script type="text/javascript" src="../../styles/eff/js/mdb.min.js"></script>
